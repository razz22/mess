    ...
    passwordInput.oninput= function(){
		...
		function poorPasswordStrength(passwordLength, poorPassword, weakPassword, strongPassword){
			if(passwordLength < 8)
			{
			   ...
			   passwordInfo.innerHTML  = '<img src="build/img/icons/angry.svg" class="me-2">' + "Weak. Must contain at least 8 characters";
		...
		function weakPasswordStrength(passwordLength, poorPassword, weakPassword, strongPassword){
			if(passwordLength >= 8 && (poorPassword || weakPassword || strongPassword))
			{
			   ...
			   passwordInfo.innerHTML = '<img src="build/img/icons/anguish.svg" class="me-2">' + "Average. Must contain at least 1 letter or number";
		   ...
		   if(passwordLength>= 8 && poorPassword && (weakPassword || strongPassword))
			{
			 ...
			 passwordStrength.classList.remove("heavy-active");
			 passwordInfo.innerHTML = '<img src="build/img/icons/smile.svg" class="me-2">' + "Almost. Must contain special symbol";
		  ...
		  if(passwordLength >= 8 && (poorPassword && weakPassword) && strongPassword)
			{
			 ...
			 passwordInfo.innerHTML = '<img src="build/img/icons/smile.svg" class="me-2">' + "Awesome! You have a secure password.";
    ...
    passwordInput1.oninput= function(){
		...
		function poor1Password1Strength1(passwordLength1, poor1Password1, weak1Password1, strong1Password1){
			if(passwordLength1 < 8)
			{
			   ...
			   passwordInfos.innerHTML  = '<img src="build/img/icons/angry.svg" class="me-2">' + "weak1. Must contain at least 8 characters";
		...
		function weak1Password1Strength1(passwordLength1, poor1Password1, weak1Password1, strong1Password1){
			if(passwordLength1 >= 8 && (poor1Password1 || weak1Password1 || strong1Password1))
			{
			   ...
			   passwordInfos.innerHTML = '<img src="build/img/icons/anguish.svg" class="me-2">' + "Average. Must contain at least 1 letter or number";
		   ...
		   if(passwordLength1>= 8 && poor1Password1 && (weak1Password1 || strong1Password1))
			{
			 ...
			 passwordStrength1.classList.remove("heavy-active");
			 passwordInfos.innerHTML = '<img src="build/img/icons/smile.svg" class="me-2">' + "Almost. Must contain special symbol";
		  ...
		  if(passwordLength1 >= 8 && (poor1Password1 && weak1Password1) && strong1Password1)
			{
			 ...
			 passwordInfos.innerHTML = '<img src="build/img/icons/smile.svg" class="me-2">' + "Awesome! You have a secure password.";
