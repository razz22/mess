...
@section('meta-description', __('Thaka Khawa Privacy Policy — how we collect, use, and protect your data.'))
  ...
  <div class="container">
    <div class="row g-5">
      ...
      <div class="col-lg-9">
        @php
        $sections = [
          ['id'=>'intro','title'=>__('1. Introduction'),'icon'=>'ti-info-circle','content'=>__('Thaka Khawa ("we", "us", or "our") operates the Thaka Khawa web application (the "Service"). This page informs you of our policies regarding the collection, use, and disclosure of personal data when you use our Service and the choices you have associated with that data. By using the Service, you agree to the collection and use of information in accordance with this policy.')],
          ...
          ['id'=>'contact','title'=>__('8. Contact Us'),'icon'=>'ti-mail','content'=>__('If you have any questions about this Privacy Policy, please contact us at: Email: privacy@thakakhawa.com | Address: Thaka Khawa, Dhaka, Bangladesh. We are committed to resolving any privacy concerns you have about our Service.')],
        ];
        @endphp
